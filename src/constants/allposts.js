...
import { FaHome, FaRegCompass, FaRegHeart } from "react-icons/fa";
...
export const allOptions = [
    { icon: IoMdHome, title: 'Home', redirectTo: '/home' },
    { icon: IoSearchOutline, title: 'Search', redirectTo: '/search' },
    { icon: FaRegCompass, title: 'Explore', redirectTo: '/explore' },
    { icon: IoMdHome, title: 'Reels', redirectTo: '/reels' },
    { icon: RiMessengerLine, title: 'Messages', redirectTo: '/messages' },
    { icon: FaRegHeart, title: 'Notifications', redirectTo: '/notifications' },
    { icon: LuPlusSquare, title: 'Create', redirectTo: '/create' },
]

export const handleAcceptFriendrequest = (id) => {
    // logic here
...
// handleAcceptFriendrequest, someFunction }